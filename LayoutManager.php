 ...
 */
namespace Juanmf\NeatReports;

use Juanmf\NeatReports\RenderStep1\ChartsStrategy\ReportsChartUtils\PathsUtils;
use Juanmf\NeatReports\RenderStep2\CompositeFactory;
use Juanmf\NeatReports\RenderStep3\Renderer;
...
class LayoutManager
{
    ...
    /**
     * Calls user defined method to generate input data. We call it with two 
     * params:
     * <ul>
    ...
    public function createLogicalScreen(array $config)
    {
        ...
        if (!($logicalScreen instanceof \DOMDocument)) {
            throw new \InvalidArgumentException('LogicalScreen Should be a DomDocument');
        }
